	...
	?>
		...
		<table class="mo_settings_table">
			<tr id="mo_oauth_display_app_name_div">
				...
				<td><input class="mo_table_textbox" type="text" value="Login with <?php echo $currentappname;?>" ></td>
			</tr>
			<tr><td><strong>Redirect / Callback URL: </strong></td>
			<td><input class="mo_table_textbox" id="callbackurl" type="text" name="mo_oauth_callback_url" value='<?php echo $currentapp['redirecturi'];?>'>
			&nbsp;&nbsp;
			...
			<tr>
				...
				<td><input class="mo_table_textbox" type="text" value=""></td>
			</tr>
			<tr>
