...
function mo_oauth_client_grant_type_settings() {
	...
	<div class="mo_table_layout" id="mo_grant_settings" style="position: relative;">
		...
		<div class="grant_types">
			...
			<input checked type="checkbox">&emsp;<strong>Authorization Code Grant</strong>&emsp;<code><small>[DEFAULT]</small></code>
			<blockquote>
			...
			<input type="checkbox">&emsp;<strong>Implicit Grant</strong>
			<blockquote>
			...
			<input type="checkbox">&emsp;<strong>Password Grant</strong>
			<blockquote>
			...
			<input type="checkbox">&emsp;<strong>Refresh Token Grant</strong>
			<blockquote>
				...
				<div>
					<table class="mo_settings_table">
						...
						<tr>
							...
							<td><input id="pkce_flow" type="checkbox" name="pkce_flow" value="0"/></td>
						</tr>
					</table>
