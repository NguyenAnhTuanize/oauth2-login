...
function mo_oauth_client_attribite_role_mapping_ui(){
	...
	<div class="mo_table_layout" id="attribute-mapping">
		...
		<tr>
			...
			<td>
				<input type="text" class="mo_table_textbox" placeholder="Enter attribute name for Last Name"  /></td>
		</tr>
		<tr>
			<td><strong>Email:</strong></td>
			<td><input type="text" class="mo_table_textbox" placeholder="Enter attribute name for Email"  value="" /></td>
		</tr>
		<tr>
			<td><strong>Group/Role:</strong></td>
			<td><input type="text" class="mo_table_textbox" placeholder="Enter attribute name for Group/Role" value="" /></td>
		</tr>
		<tr>
			<td><strong>Display Name:</strong></td>
			<td>
				<select  class="mo_table_textbox" style="background-color: #eee;">
			...
			<tr>
				<td colspan="2">
					<strong>
						<input type="checkbox"> Keep Existing User Attributes
			...
			<tr>
			  	<td colspan="2">
				    <table>
						<tr>
						  	<td>
						  		<strong><input type="checkbox"> Keep Existing Email Attribute</strong><small> <a href="admin.php?page=mo_oauth_settings&tab=licensing" target="_blank" rel="noopener noreferrer">[PREMIUM]</a></small>
						  	</td>
						</tr>
			...
			</td><td><input type="button" value="+" class="button button-primary"  /></td>
			<td><input type="button" value="-" class="button button-primary"   /></td></tr>
			<tr class="rows"><td><input type="text" placeholder="Enter field meta name" /></td>
			<td><input type="text" placeholder="Enter attribute name from OAuth Provider"  class="mo_table_textbox" /></td>
			</tr>';
			?>
			</table>
			<br>
		...
		<p><input type="checkbox"/><strong> Keep existing user roles</strong><br><small>Role mapping won't apply to existing wordpress users.</small></p>
		<p><input type="checkbox" > <strong> Do Not allow login if roles are not mapped here </strong></p><small>We won't allow users to login if we don't find users role/group mapped below.</small></p>
		...
		<div id="panel1">
			<table class="mo_oauth_client_mapping_table" id="mo_oauth_client_role_mapping_table" style="width:90%">
				...
				<tr>
					<td><input class="mo_oauth_client_table_textbox" type="text" placeholder="group name" />
					</td>
					<td>
						<select style="width:100%"  >
							<option>Subscriber</option>
